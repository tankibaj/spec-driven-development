...
- `contracts/api/order-service.openapi.yaml` — `POST /auth/login`, `POST /auth/mfa/verify`, `LoginRequest`, `LoginResponse`, `MfaVerifyRequest`, `MfaVerifyResponse` schemas, `bearerAuth` security scheme
