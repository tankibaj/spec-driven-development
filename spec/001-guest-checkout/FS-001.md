...
**PRD:** PRD-001 — MVP Guest Shopping Experience
**Status:** Draft
**Author:** SDD Agent
...
**Primary persona:** Grace — The Casual Shopper (see `docs/reference/personas.md`)
**Secondary persona:** Priya — The Operations Manager (see `docs/reference/personas.md`)
...
**Existing contracts:**
- `workspaces/order-service/docs/api/openapi.json` — guest sessions, order placement, order queries
- `workspaces/inventory-service/docs/api/openapi.json` — product catalogue, stock management
- `workspaces/notification-service/docs/api/openapi.json` — transactional notifications
- `workspaces/order-service/docs/schema/entities.md` — orders and order lines tables
- `workspaces/inventory-service/docs/schema/entities.md` — products, SKUs, stock levels, reservations tables
- `docs/architecture/observability-standards.md` — health, metrics, logging standards
- `docs/architecture/contract-validation.md` — Schemathesis, Pact, MSW standards
