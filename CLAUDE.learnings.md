...
- 2026-04-11: CLAUDE.md and README.md updated to reflect full 5-phase workflow (Phase 0–4): PDR → FS+IA → TS → WPs → Implement. Phase 2+3 use a single review gate (human reviews TS and WPs together). Phase 4 has a prerequisite gate check. Artifact lifecycle: draft → awaiting_review → approved/rejected. New SDD skills added to context loading table: sdd-feature-concept, sdd-feature-spec, sdd-plan.
